...
http://wiki.bitnami.com/Infrastructure_Stacks/Bitnami_AMP_Stacks#How_can_I_add_applications_on_top_of_AMP.3f
...
http://wiki.bitnami.com/Infrastructure_Stacks/Bitnami_AMP_Stacks
...
bitnami-mampstack-5.4.26-0-osx-x86-installer.dmg 
...
a regular user, or /opt/mampstack-5.4.26-0, if you are running the 
...
/Applications/mampstack-5.4.26-0 and that you use port 8080 for Apache and 3306 for MySQL.
